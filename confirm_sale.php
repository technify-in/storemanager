...
<a class="list-group-item" href="dashboard.php"><i class="fa fa-home fa-fw"></i>&nbsp; Home</a>
      <form action="bill.php" method="GET">
		...
		print "<input name=\"name\" type='hidden' class=\"name\" value='$_REQUEST[name]' ><br/>";

		print $_REQUEST['address'] . "<br/>";
		print "<input name=\"address\" type='hidden' class=\"address\" value='$_REQUEST[address]' ><br/>";

		print $_REQUEST['contact'] . "<br/>";
		print "<input name=\"contact\" type='hidden' class=\"contact\" value='$_REQUEST[contact]' ><br/>";
